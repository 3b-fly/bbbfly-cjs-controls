...
bbbfly.edit._setFocusAfter=function(){var a=this.GetText();this.SetFocus(!0);this.SetCaretPos(String.isString(a)?a.length:0)};bbbfly.edit._normalizeButtons=function(a){if(a.Buttons){if(Object.isObject(a.Buttons)){var b=[],c;for(c in a.Buttons){var d=a.Buttons[c];ng_MergeDef(d,{Data:{ButtonId:c}});b.push(d)}a.Buttons=b}}else a.Buttons=[]};bbbfly.memo._onGetClassName=function(a,b){return b+(a.Invalid?"Invalid":"")};
