...
bbbfly.GridPanel=function(b,c,a){b=b||{};ng_MergeDef(b,{ScrollBars:ssAuto,Data:{AutoSize:!0,MinColumnWidth:200,MaxColumnWidth:400,_Rows:[],_Columns:[]},Events:{OnUpdated:bbbfly.grid._onUpdated,OnAutoSized:null}});return ngCreateControlAsType(b,"ngPanel",c,a)};
bbbfly.GridGroup=function(b,c,a){b=b||{};ng_MergeDef(b,{ScrollBars:ssNone,Data:{AutoSize:!0,MinColumnWidth:200,MaxColumnWidth:400,_Rows:[],_Columns:[]},Events:{OnUpdate:bbbfly.grid._onUpdate,OnAutoSized:null}});return ngCreateControlAsType(b,"ngGroup",c,a)};ngUserControls=ngUserControls||[];ngUserControls.bbbfly_grid={OnInit:function(){ngRegisterControlType("bbbfly.GridPanel",bbbfly.GridPanel);ngRegisterControlType("bbbfly.GridGroup",bbbfly.GridGroup)}};
