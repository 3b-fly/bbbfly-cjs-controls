...
bbbfly.imagepreview._getImageNode=function(a){if(!a||!String.isString(a.ID))return null;var b=a.ID+"_IMG",c=document.getElementById(b);if(!c){a=a.Elm();if(!a)return null;ng_SetInnerHTML(a,'<img id="'+b+'" style="position:absolute;left:50%;top:50%;max-width:100%;max-height:100%;background-color:transparent"/>');if(c=document.getElementById(b))c.onload=function(){this.style.marginLeft=Number.isNumber(this.width)?-(this.width/2)+"px":"0px";this.style.marginTop=Number.isNumber(this.height)?-(this.height/
2)+"px":"0px"}}return c};bbbfly.imagepreview._setImage=function(a){var b=bbbfly.imagepreview._getImageNode(this.Controls.Image);b&&(b.src="",String.isString(a)&&(b.src=a))};bbbfly.imagepreview._onCreated=function(a){String.isString(a.ImgUrl)&&a.SetImage(a.ImgUrl);return!0};
