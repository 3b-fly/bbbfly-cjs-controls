...
CtrlSendToBack:bbbfly.toolbar._ctrlSendToBack,CtrlInsertAfter:bbbfly.toolbar._ctrlInsertAfter,CtrlInsertBefore:bbbfly.toolbar._ctrlInsertBefore}});return ngCreateControlAsType(a,"bbbfly.Panel",b,c)};ngUserControls=ngUserControls||[];ngUserControls.bbbfly_layout={OnInit:function(){ngRegisterControlType("bbbfly.ToolBar",bbbfly.ToolBar)}};bbbfly.ToolBar.valign={top:"top",bottom:"bottom"};bbbfly.ToolBar.halign={left:"left",right:"right"};
