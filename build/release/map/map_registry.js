...
bbbfly.map.registry._registerMap=function(a){if(!a||!String.isString(a.ID)||this._Maps[a.ID])return!1;if(Function.isFunction(a.CtrlInheritsFrom)&&a.CtrlInheritsFrom("bbbfly.Map")){this._Maps[a.ID]=a;for(var b in this._UnlinkedControls){var c=this._UnlinkedControls[b];c.mapID===a.ID&&Function.isFunction(c.LinkToMap)&&c.LinkToMap(a)&&(delete this._UnlinkedControls[b],this._MapControls[b]=c)}return!0}return!1};
bbbfly.map.registry._registerControl=function(a){return!a||!String.isString(a.ID)||this._UnlinkedControls[a.ID]||this._MapControls[a.ID]?!1:Function.isFunction(a.CtrlInheritsFrom)&&a.CtrlInheritsFrom("bbbfly.MapControl")?((this.LinkControl(a)?this._MapControls:this._UnlinkedControls)[a.ID]=a,!0):!1};bbbfly.map.registry._linkControl=function(a){if(!a||!String.isString(a.MapID))return!1;var b=this.GetMap(a.MapID);return b?Function.isFunction(a.LinkToMap)?a.LinkToMap(b):!1:!1};
