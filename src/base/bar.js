 ...
 * @property {boolean|bbbfly.Renderer.frame} [SlideFrame=false] - Slide buttons definition
 *   Define frame or set it to true before panel creation to support slide buttons
 */
 ...
 * @description
 *   Possible values for
 *   {@link bbbfly.Bar.barOptions|bbbfly.Bar.barOptions.HAutoSize}
 *   and {@link bbbfly.Bar.barOptions|bbbfly.Bar.barOptions.VAutoSize}
 */
bbbfly.Bar.autosize = {
  none: 0,
  stretch: 1,
 ...
 * @property {bbbfly.Bar.autosize} [HAutoSize=none]
 * @property {bbbfly.Bar.autosize} [VAutoSize=none]
