 ...
 * @property {px} [VPadding=0]
 * @property {px} [HPadding=0]
 * @property {bbbfly.ToolBar.valign} [VAlign=top]
 * @property {bbbfly.ToolBar.halign} [HAlign=left]
 * @property {boolean} [Wrapable=true]
